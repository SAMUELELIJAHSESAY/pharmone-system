...
## Logo decision
- Official logo: user-approved SamMia Pharm monogram/capsule mark.
- The application uses the supplied logo artwork exactly as provided, with transparent cropping only for asset sizing.
- The mark is paired with real Inter text for “SamMia Pharm” inside the application.
